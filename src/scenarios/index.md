...
面向专业设计软件（DCC/CAD）的 AI 助手方案，让 AI 通过脚本 API 直接驱动 Blender、FreeCAD、Rhino 等专业工具：
...
| 设计师 / 三维美术 | Blender 三维创作助手 → Rhino 建筑与工业设计助手 → FreeCAD 参数化设计助手 |
...
| 建筑/设计 | Rhino 助手（方案建模出图）+ Blender 助手（效果图渲染）+ 文档处理（设计说明） |
